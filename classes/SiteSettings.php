...
class SiteSettings {
	...
	function settingsLink() {
		add_options_page( 'UCSC Service Block Settings', 'UCSC Service Block Settings', 'manage_options', 'ucsc-service-blocks-plugin-settings', array( $this, 'settingsPageHTML' ) );
	}
